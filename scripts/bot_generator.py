...
def generate_confession():
    ...
    1. ОБ'ЄМ: Текст має складатися СТРОГО з 4-5 речень. Не менше і не більше.
    2. КРИТИЧНО: НІКОЛИ не звертайся до неї по імені (НЕ пиши "Вікторіє", "Віка" тощо). 
    3. Використовуй теплі, ніжні звертання: "Кохана", "Рідна моя", "Сонечко моє", "Серце моє", "Мій затишок".
    4. ТАБУ НА ЦИФРИ: Жодних згадок про роки, дати чи тривалість стосунків (НЕ пиши про "роки поруч", "десятиліття", "скільки ми разом"). Почуття мають бути поза часом.
    5. Грамматика: Тільки від першої особи чоловічого роду (я почув, я люблю) до жінки (твоя, ти). ЖОДНИХ варіантів через слеш типу "коханий/кохана".
    6. Стиль: Проста, жива, сучасна українська мова. Текст має звучати так, ніби чоловік обійняв її ззаду за плечі і тихо шепнув це на вушко вранці на кухні.

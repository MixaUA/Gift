...
def generate_confession(previous_confession=None, previous_topic=None):
    ...
    ТЕМИ ДЛЯ НАТХНЕННЯ (щодня обирай різну):
    її сміх, ранкова кава разом, тепло її рук, спільна тиша вдома,
    її погляд збоку, звук її кроків, відчуття її поруч уві сні,
    як вона читає, її голос по телефону, спільні плани на майбутнє,
    як вона турбується про інших, її звички які він любить.
    """

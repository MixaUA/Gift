...
CONFESSION_TOPICS = [
    ...
    "те як вона слухає", "те як она дивиться", "те як вона усміхається",
...
CONFESSION_STYLES = [
    ...
    "дивування — коли дивишся на неї і досі не можеш поверити своєму щастю",
...
3. МІНІМІЗУЙ займенники "я", "ти", "мій", "твій". Дозволено використати ОДИН присвійний займенник ("твоя", "твоїх", "твоєму", "твою") на весь текст і лише там, де це критично необхідно для створення інтимності та зв'язку. Решту тексту очищуй від займенникового сміття — відчуття особистості має зчитуватися з дієслівних закінчень ("люблю", "бережу").
...
5. Максимално очисти текст від слів-паразитів "я", "ти", "мій", "твій". Дозволено використати лише ОДИН присвійний займенник ("твоя", "твоїх", "твоєму", "твою") на весь текст для підкреслення особистого моменту. Нехай кожне слово буде вагомим.
